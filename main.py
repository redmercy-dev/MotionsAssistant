...
def stream_response_with_file_search(
    ...
    """
    Stream a response using Responses API with file_search tool.
    ...
    # Create response with file_search tool
    try:
        ...
        # Get the complete response for file extraction
        # Note: In Responses API, we need to retrieve the response to get files
        # Files would typically be generated via code_interpreter tool
